...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--mode', choices={"baseline", "ours"},
                                 default="baseline",
                                 help=("choose whether or not to use our model"))
        ...
        #FEDformer
        self.parser.add_argument('--version', type=str, default='Fourier',
                    help='for FEDformer, there are two versions to choose, options: [Fourier, Wavelets]')
        self.parser.add_argument('--mode_select', type=str, default='random',
                    help='for FEDformer, there are two mode selection method, options: [random, low]')
        self.parser.add_argument('--modes', type=int, default=64, help='modes to be selected random 64')
        self.parser.add_argument('--L', type=int, default=3, help='ignore level')
        self.parser.add_argument('--enc_in', type=int, default=7, help='encoder input size')
        ...
        self.parser.add_argument('--base', type=str, default='legendre', help='mwt base')
        ...
        self.parser.add_argument('--moving_avg', default=25, help='window size of moving average')
        self.parser.add_argument('--factor', type=int, default=3, help='attn factor')
        ...
        self.parser.add_argument('--gpt_layer', type=int, default=6, help='gpt layers')
    def parse(self):
